                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mb-4">فیلتر ها</h4>
                    ...
                    <div class="card-body">
                        <div class="filters">
                            ...
                            <label>شناسه کاربر در مودل:</label>
                            <input type="text" id="moodle_user_id">
                            <label>نام:</label>
                            ...
                            <button id="filter-button">جستجو</button>
                        </div><!-- bd -->
                    </div><!-- bd -->
                </div><!-- bd -->
            </div>
                        ...
                        <div class="table-responsive">
                            ...
                            @else
                                <div class="text-center">
                                    <img class="width-50" src="https://cdn.dribbble.com/users/220043/screenshots/6288970/dttr_loaderricerca_ac_ver1.gif" style="width: 250px;">
